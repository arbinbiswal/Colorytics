...
export default function Home() {
  ...
  // Global format selector for color display
          ...
          <div className="flex flex-col gap-4 w-full border-x border-dashed max-w-4xl mx-auto">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 w-full">
              <div className="flex flex-col gap-4 p-4 lg:p-8">
                <h1 className="text-2xl font-semibold">colorytics</h1>
                            ...
                            >
                              ...
                              <div className="mt-2 px-1">
                                <div className="flex items-center justify-between gap-2">
                                  <div className="h-7 text-xs text-muted-foreground flex items-center px-0">
                                    color {index + 1}
                                  </div>
                                  <Button
                                    variant="ghost"
                                ...
                                <button
                                  className="
                                    mt-1 w-full text-left font-mono text-[10px]
